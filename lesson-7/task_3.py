...
class Cell:
    ...
    def __add__(self, other):
        result = Cell(0)
        result.quantity = self.quantity + other.quantity
        return result
    ...
    def __sub__(self, other):
        if self.quantity >= other.quantity:
            ...
            result.quantity = self.quantity - other.quantity
            return result
        raise ValueError('Нельзя из меньшего вычесть большего')
    ...
    def __truediv__(self, other):
        result = Cell(0)
        result.quantity = round(self.quantity / other.quantity, 0)
        return result
...
if __name__ == "__main__":
    orig_cell_1 = Cell(enter("Введите количество клеток\n>>>:"))
    orig_cell_2 = Cell(enter("Введите количество клеток\n>>>:"))
    orig_row = enter("Введите число ячеек в ряду\n>>>:")
    orig_cell_3 = orig_cell_1 / orig_cell_2
    print(orig_cell_3.make_order(int(orig_row)))
